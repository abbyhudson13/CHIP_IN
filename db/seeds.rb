...
file3 = URI.open('https://res.cloudinary.com/dqlvehu5z/image/upload/v1583402666/CHIP-IN/Volunteers/claire_s9sxz4.jpg')
...
claire.photo.attach(io:file3, filename:'logo3.jpg', content_type: 'image/jpg')

#volunteer 5

file4 = URI.open('https://res.cloudinary.com/dqlvehu5z/image/upload/v1583402446/CHIP-IN/Volunteers/Tim_qoabmr.jpg')
...
file5 = URI.open('https://res.cloudinary.com/dqlvehu5z/image/upload/v1583404421/CHIP-IN/Volunteers/55158466_vswfwr.jpg')
...
abby.photo.attach(io:file5, filename:'logo5.jpg', content_type: 'image/jpg')
